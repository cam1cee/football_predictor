...
def predict_match_poisson(home_team, away_team, team_stats, df):
    ...
    for home_goals in range(max_goals + 1):
        for away_goals in range(max_goals + 1):
            # Probability of this exact scoreline using our custom function
            prob = (poisson_probability(home_goals, expected_home_goals) * 
                   poisson_probability(away_goals, expected_away_goals))
